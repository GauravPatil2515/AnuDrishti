...
\begin{enumerate}
    ...
    \item \textbf{Supporting Infrastructure}: Substructure Mapper (45 SMARTS patterns) with a size-invariant adaptive attention cutoff, an ADMET Rule Engine (decision-support flagging), and a production web platform demonstrating real-world applicability.
\end{enumerate}
...
Post-inference, we convert attention weights into chemically meaningful explanations. The Substructure Mapper maintains a database of 45 known toxicophores encoded as SMARTS patterns, organized by toxicity mechanism:
