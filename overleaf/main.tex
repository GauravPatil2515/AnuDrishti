...
\begin{table}[h]
\centering
\caption{Sensitivity Analysis for the Adaptive Cutoff Factor $\kappa$ and Causal Threshold $\delta$. \TODO{These values must be regenerated with the live LLM; the current table predates the real-LLM evaluation.}}
