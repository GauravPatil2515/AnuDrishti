...
\newcommand{\Fconstrained}{\TODO{F\_constr}}   % mean faithfulness, constrained (claim-bearing)
\newcommand{\Funconstrained}{\TODO{F\_uncon}}  % mean faithfulness, unconstrained baseline
\newcommand{\RejRate}{\TODO{rej\%}}            % rejection rate, constrained (claim-bearing)
\newcommand{\Gconstr}{\TODO{Sg\_c}}            % grounding, constrained
\newcommand{\Guncon}{\TODO{Sg\_u}}             % grounding, unconstrained
\newcommand{\Cconstr}{\TODO{Sc\_c}}            % causal, constrained
\newcommand{\Cuncon}{\TODO{Sc\_u}}             % causal, unconstrained
\newcommand{\NwithClaims}{\TODO{N\_claims}}    % # molecules with >=1 toxicophore claim
...
\midrule
\textbf{DeNovo (Ours)} & 0.802 & \TODO{auc} & \TODO{auc} \\
\bottomrule
\end{tabular}
\end{table}
...
-- Attention Pooling (Mean) & \TODO{auc} & -- \\
-- Transfer Learning & \TODO{auc} & \TODO{F} \\
-- Causal Validation (grounding only) & 0.837 & \TODO{F} \\
\bottomrule
\end{tabular}
\end{table}
...
\midrule
1.5 & 0.10 & \TODO{rej} & \TODO{F} \\
\textbf{2.0} & \textbf{0.10} & \RejRate{} & \Fconstrained{} \\
3.0 & 0.10 & \TODO{rej} & \TODO{F} \\
2.0 & 0.05 & \TODO{rej} & \TODO{F} \\
2.0 & 0.15 & \TODO{rej} & \TODO{F} \\
\bottomrule
\end{tabular}
\end{table}
