...
% 200 molecules evaluated, claim-bearing subset (n=7), 2026-07.
\newcommand{\Fconstrained}{1.000}   % mean F on accepted explanations (claim-bearing subset)
\newcommand{\FconAll}{0.865}        % mean F over all 200 molecules (overall)
\newcommand{\RejRate}{13.5\%}         % rejection rate, constrained (over 200 attempts)
\newcommand{\Gconstr}{1.000}        % mean grounding, constrained
\newcommand{\Cconstr}{0.865}          % mean causal, constrained
\newcommand{\NwithClaims}{7}       % # molecules (of 200) with >=1 claim
\newcommand{\Ntoxic}{200}            % # molecules evaluated
% Unconstrained baseline: live LLaMA-3.3-70B, SAME 50 molecules.
\newcommand{\Funconstrained}{0.054} % mean F, unconstrained
